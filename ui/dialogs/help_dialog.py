...
SHORTCUTS = [
    ...
    (N_("Volume up"), "F11"),
    (N_("Volume down"), "F12"),
    (N_("Squelch up"), "Shift+F11"),
    (N_("Squelch down"), "Shift+F12"),
    (N_("Mute / Unmute"), "F3"),
    (N_("Toggle recording"), "R"),
    (N_("Read signal strength"), "I"),
    ("", ""),
    (N_("--- Channels / Bands (VFO / MR) ---"), ""),
    (N_("Channel up (MR) / frequency step up (VFO)"), "Page Up"),
    (N_("Channel down (MR) / frequency step down (VFO)"), "Page Down"),
    (N_("Toggle VFO / Memory mode"), "V"),
    (N_("Previous band (VFO)"), "["),
    (N_("Next band (VFO)"), "]"),
    ("", ""),
    ...
    ("", ""),
    (N_("--- General ---"), ""),
    (N_("Open Radio menu (bands, scanner)"), "Alt+R"),
    (N_("Quit"), "Alt+F4"),
]
